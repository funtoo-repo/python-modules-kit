...
DESCRIPTION="A PEP 518 build backend that uses setuptoolsscm to generate a version file from your version control system then flit to build the package."
