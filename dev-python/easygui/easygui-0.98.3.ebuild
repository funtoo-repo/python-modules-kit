...
DESCRIPTION="EasyGUI is a module for very simple very easy GUI programming in Python.  EasyGUI is different from other GUI generators in that EasyGUI is NOT eventdriven.  Instead all GUI interactions are invoked by simple function calls."
